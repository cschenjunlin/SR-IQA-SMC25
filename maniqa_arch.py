...
default_model_urls = {
    ...
    'pipal-split1': '/home/user/study/IQA/MANIQA/maniqa-pipal-split1.pt',
    ...
    'pesudo-label': '/home/user/study/IQA/Others1213/checkpoints/MANIQA/weightedLoss0.01/1/MANIQA_pseudo_best.pt',
}
...
class MANIQA(nn.Module):
    ...
    def forward(self, x, crop_num):
        """
        Forward pass of the MANIQA model.

        Args:
            x (torch.Tensor): Input image tensor.
            crop_num (int): Crop patches num.
